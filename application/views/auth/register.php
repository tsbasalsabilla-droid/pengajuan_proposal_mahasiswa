...
<div class="wrap">
  ...
  <div class="left">
    ...
    <form method="post" action="<?= base_url('Auth/registration'); ?>" autocomplete="off" style="width:100%;">
      <!-- TRICK AUTOFILL -->
      ...
      <div class="field-wrap">
        ...
        <input type="text" id="name" name="user_name" placeholder="Full Name" value="" autocomplete="off">
        <?= form_error('user_name', '<small style="color:#dc2626;font-size:11px;padding-left:4px;">', '</small>'); ?>
      </div>
      ...
      <div class="field-wrap">
        ...
        <input type="password" id="password1" name="user_password1" placeholder="Password" autocomplete="new-password">
        <?= form_error('user_password1', '<small style="color:#dc2626;font-size:11px;padding-left:4px;">', '</small>'); ?>
      </div>
      ...
      <div class="field-wrap">
        ...
        <input type="password" id="password2" name="user_password2" placeholder="Repeat Password" autocomplete="new-password">
      </div>
